...
class Member(User):
    ...
    def __init__(self, name, location, age, aadhar_id, student_id):
        ...
        print("Welcome to Library {}!".format(name))
    ...
    def IssueBook(self, book_title):
        ...
        for condition in conditions:
            ...
            book_item = IssueReturn.IssueBook(self.name, self.student_id, book_title, days)
            self.issued_books_list.append(book_item)
            print("Book issued successfully!")
            print("Take your copy {} from rack {}".format(book_item.isbn, book_item.rack))


    def returnBook(self):
        global ret_book_item
        ...
        IssueReturn.returnBook(ret_book_item, days)
